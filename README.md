...
Cloudflare Worker. The author rebuilds their own private dashboard locally from
`log.xlsx`; a public **`demo.html`** built from the sample `transactions.csv`
is regenerated daily by GitHub Actions.
